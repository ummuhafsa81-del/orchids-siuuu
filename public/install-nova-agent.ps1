# Nova Agent Installer for Windows
# This script automatically installs Python (if needed) and builds NovaAgent.exe
...
# Build the EXE
Write-Host ""
Write-Host "[*] Building NovaAgent.exe (this may take 1-2 minutes)..." -ForegroundColor Cyan
...
if (Test-Path $exePath) {
    ...
    Write-Host "     SUCCESS! NovaAgent.exe created!     " -ForegroundColor Green
    Write-Host "==========================================" -ForegroundColor Green
    Write-Host ""
    Write-Host "Location: $desktopPath\NovaAgent.exe" -ForegroundColor White
    Write-Host ""
    Write-Host "Double-click NovaAgent.exe to run it!" -ForegroundColor Cyan
    Write-Host ""
